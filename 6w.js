 ...
 * Version: 1.0
 * Auto-generates TOC from post headings
 */
...
(function() {
  ...
  function toc_scrollTo(element) {
    ...
    var scrollTop = elemRect.top - bodyRect.top - offset;
  ...
  function toc_build() {
    ...
    // Find the post content area (Blogger's post body)
  ...
  function toc_updateActive() {
    var scrollPos = window.pageYOffset + toc_config.scrollOffset + 100;
    var found = null;
  ...
  function toc_init() {
    ...
    // Scroll listener
    window.addEventListener('scroll', toc_throttle(toc_updateActive, 100));
