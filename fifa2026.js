...
(function() {
  ...
  const css = `
    ...
    @keyframes wc-ballBounce {
      ...
      25%  { transform: translateY(-4px) rotate(15deg) scale(1.12); }
      50%  { transform: translateY(0) rotate(0deg) scale(1); }
      75%  { transform: translateY(-2px) rotate(-10deg) scale(1.06); }
    }
    .wc-header-title {
      font-size: 13px;
      font-weight: 700;
    ...
    @media (max-width: 320px) {
      .wc-widget-header { padding: 10px 10px; }
      .wc-header-title { font-size: 11px; letter-spacing: 0.3px; }
      .wc-header-stage { font-size: 8px; padding: 2px 4px; }
      .wc-match-card { padding: 10px 10px; }
      .wc-team-name { font-size: 11px; }
      .wc-vs-text { font-size: 10px; }
      .wc-flag-img { width: 16px; height: 12px; }
      .wc-score-display { font-size: 15px; }
      .wc-match-meta { gap: 5px; font-size: 10px; }
      .wc-match-status { margin-left: 6px; min-width: 40px; }
      .wc-live-badge { font-size: 8px; padding: 2px 4px; }
      .wc-match-counter { font-size: 9px; padding: 6px 10px; }
    }
    @media (min-width: 321px) and (max-width: 480px) {
      .wc-widget-header { padding: 11px 12px; }
      .wc-header-title { font-size: 12px; }
      .wc-match-card { padding: 11px 12px; }
      .wc-team-name { font-size: 12px; }
      .wc-score-display { font-size: 16px; }
      .wc-match-meta { font-size: 10px; }
    }
    @media (min-width: 768px) {
      .wc-widget-header { padding: 14px 18px; }
      .wc-header-title { font-size: 14px; }
      .wc-match-card { padding: 14px 18px; }
      .wc-team-name { font-size: 14px; }
      .wc-score-display { font-size: 20px; }
      .wc-flag-img { width: 24px; height: 18px; }
      .wc-match-meta { font-size: 12px; }
      .wc-live-badge { font-size: 10px; padding: 3px 8px; }
    }
  `;
    ...
    document.getElementById("wc-match-container").innerHTML = `
      <a class="wc-match-card wc-fade-in" href="${MATCH_LINK}" target="_blank">
        <div class="wc-no-match">
          ...
          <div style="font-size:11px;margin-top:6px;color:#adb5bd;">Click to view full schedule</div>
        </div>
      </a>`;
