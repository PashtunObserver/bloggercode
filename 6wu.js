 ...
 * Version: 2.0 - Fixed scroll shaking & jump-back issues
 */
...
(function() {
  ...
  var toc_isClickScrolling = false;      // Flag: true during click scroll
  var toc_clickScrollTimeout = null;     // Timer to clear flag
  ...
  function toc_build() {
    ...
    // Find headings within post body, excluding TOC itself
  ...
  function toc_bindClicks() {
    ...
    for (var i = 0; i < links.length; i++) {
      links[i].addEventListener('click', function(e) {
        ...
        // Update active immediately without scrollIntoView
        ...
        // Clear flag after smooth scroll completes (~800ms)
  ...
  function toc_updateActive() {
    // Skip if we just clicked a link (prevents fighting)
    ...
    if (found && found.id !== toc_activeId) {
      ...
      if (newActive) {
        ...
        // Only scroll TOC item into view if user is NOT hovering over TOC
        // This prevents jumpy behavior
        if (!toc_container.matches(':hover')) {
