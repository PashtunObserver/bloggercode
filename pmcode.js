<!-- ═══════════════════════════════════════════════════════════════
     PMCODE SYNTAX HIGHLIGHTER WIDGET FOR BLOGGER
     Version: 2.0
     Author: Custom Build
     Description: A shortcode-based code block widget for Blogger

     HOW TO USE IN YOUR BLOGGER POSTS:
     ─────────────────────────────────
     In Compose View, simply type:
     ...
     [PMCODE]
     Any other general code here
     [/PMCODE]

     Available languages: js, css, html (all others = general)
     ═══════════════════════════════════════════════════════════════ -->

<!-- ═══════════════ PMCODE WIDGET STYLES ═══════════════ -->


<!-- ═══════════════ PMCODE WIDGET SCRIPT ═══════════════ -->
<script id="pmcode-widget-script">
// ════════════════════════════════════════════════════════
// PMCODE WIDGET - ISOLATED JAVASCRIPT
// All functions prefixed with "pmcode_" to avoid conflicts
// ════════════════════════════════════════════════════════
