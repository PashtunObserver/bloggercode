 ...
 * Version: 1.0
 * Fetches recent 5 posts from "Current Affairs" label
 */
...
(function() {
  ...
  var caw_config = {
    ...
    loadingText: 'Loading Current Affairs...',
    errorText: 'Unable to load posts. Please try again later.',
    noPostsText: 'No posts found in Current Affairs.',
    fallbackImage: ''
  };
  ...
  function caw_init() {
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', caw_fetchPosts);
    } else {
      caw_fetchPosts();
    }
  }
