...
// Host on: GitHub Pages / jsDelivr / RawGit
// ============================================
...
(function() {
    ...
    rsoftStyles.textContent = '.rsoft-card,.rsoft-card *,.rsoft-card *::before,.rsoft-card *::after{margin:0;padding:0;box-sizing:border-box}.rsoft-card{width:100%;max-width:100%;background:#fff;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,.08);overflow:hidden;transition:box-shadow .3s ease;font-family:"Segoe UI",Tahoma,Geneva,Verdana,sans-serif;line-height:1.5}.rsoft-card:hover{box-shadow:0 8px 30px rgba(0,0,0,.12)}.rsoft-ad-header{width:100%;min-height:90px;background:#f8f9fa;border-bottom:2px dashed #dee2e6;display:flex;align-items:center;justify-content:center;padding:15px;position:relative}.rsoft-ad-placeholder{width:100%;max-width:728px;height:90px;background:#e9ecef;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#6c757d;font-size:14px;font-weight:500;gap:8px}.rsoft-ad-placeholder .fa{font-size:18px;color:#adb5bd}.rsoft-cover-wrap{width:100%;height:0;padding-bottom:56.25%;position:relative;overflow:hidden;background:#1a1a2e}.rsoft-cover-img{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;transition:transform .5s ease}.rsoft-card:hover .rsoft-cover-img{transform:scale(1.05)}.rsoft-content{padding:24px}.rsoft-title{font-size:1.75rem;font-weight:700;color:#1a1a2e;margin-bottom:16px;line-height:1.3;font-family:inherit}.rsoft-title .fa{color:#0984e3;margin-right:8px}.rsoft-info-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:20px}.rsoft-info-box{background:#f8f9fa;border-radius:12px;padding:16px 12px;text-align:center;border:1px solid #e9ecef;transition:all .3s ease}.rsoft-info-box:hover{background:#e9ecef;transform:translateY(-2px);box-shadow:0 4px 12px rgba(0,0,0,.06)}.rsoft-info-ico{font-size:1.4rem;color:#0984e3;margin-bottom:8px;display:block}.rsoft-info-lbl{font-size:.75rem;font-weight:600;color:#6c757d;text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px}.rsoft-info-val{font-size:1rem;font-weight:700;color:#1a1a2e}.rsoft-countdown-box{display:none;align-items:center;justify-content:center;gap:12px;padding:20px;background:#fff3cd;border-radius:12px;border:1px solid #ffeaa7;margin-bottom:20px}.rsoft-countdown-box.rsoft-active{display:flex}.rsoft-countdown-ico{font-size:24px;color:#e17055;animation:rsoft-pulse 1s infinite}@keyframes rsoft-pulse{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.1);opacity:.8}}.rsoft-countdown-txt{font-size:1.1rem;font-weight:600;color:#d63031}.rsoft-countdown-num{font-family:"Courier New",monospace;font-size:1.5rem;font-weight:700;color:#d63031;background:#fff;padding:4px 12px;border-radius:6px;min-width:50px;text-align:center;box-shadow:0 2px 8px rgba(214,48,49,.15)}.rsoft-countdown-box.rsoft-paused{background:#e8f4f8;border-color:#74b9ff}.rsoft-countdown-box.rsoft-paused .rsoft-countdown-ico{animation:none;color:#0984e3}.rsoft-countdown-box.rsoft-paused .rsoft-countdown-txt{color:#0984e3}.rsoft-countdown-box.rsoft-paused .rsoft-countdown-num{color:#0984e3;box-shadow:0 2px 8px rgba(9,132,227,.15)}.rsoft-paused-tag{display:none;font-size:.75rem;font-weight:700;color:#0984e3;background:#fff;padding:2px 8px;border-radius:4px;text-transform:uppercase;letter-spacing:1px}.rsoft-countdown-box.rsoft-paused .rsoft-paused-tag{display:inline-block}.rsoft-action-wrap{width:100%}.rsoft-btn-blue{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:16px 24px;background:#0984e3;color:#fff;text-decoration:none;border-radius:12px;font-size:1.1rem;font-weight:600;transition:all .3s ease;cursor:pointer;border:none;outline:none;font-family:inherit}.rsoft-btn-blue:hover{background:#0770c2;transform:translateY(-2px);box-shadow:0 6px 20px rgba(9,132,227,.3)}.rsoft-btn-blue:active{transform:translateY(0)}.rsoft-btn-blue .fa{font-size:1.2rem}.rsoft-btn-green{display:none;align-items:center;justify-content:center;gap:10px;width:100%;padding:16px 24px;background:#00b894;color:#fff;text-decoration:none;border-radius:12px;font-size:1.1rem;font-weight:600;transition:all .3s ease;cursor:pointer;border:none;outline:none;font-family:inherit}.rsoft-btn-green.rsoft-visible{display:flex;animation:rsoft-success-pop .4s ease forwards}.rsoft-btn-green:hover{background:#00a383;transform:translateY(-2px);box-shadow:0 6px 20px rgba(0,184,148,.3)}.rsoft-btn-green .fa{font-size:1.2rem}.rsoft-spinner{display:none;width:20px;height:20px;border:3px solid rgba(255,255,255,.3);border-top-color:#fff;border-radius:50%;animation:rsoft-spin .8s linear infinite}.rsoft-btn-blue.rsoft-loading .rsoft-spinner{display:inline-block}.rsoft-btn-blue.rsoft-loading .rsoft-btn-txt{display:none}@keyframes rsoft-spin{to{transform:rotate(360deg)}}@keyframes rsoft-success-pop{0%{transform:scale(.9);opacity:0}50%{transform:scale(1.05)}100%{transform:scale(1);opacity:1}}@media(max-width:768px){.rsoft-content{padding:18px}.rsoft-title{font-size:1.4rem}.rsoft-info-grid{gap:8px}.rsoft-info-box{padding:12px 8px}.rsoft-info-ico{font-size:1.2rem}.rsoft-info-lbl{font-size:.7rem}.rsoft-info-val{font-size:.9rem}.rsoft-btn-blue,.rsoft-btn-green{padding:14px 20px;font-size:1rem}.rsoft-ad-placeholder{height:60px;font-size:12px}.rsoft-countdown-txt{font-size:.95rem}.rsoft-countdown-num{font-size:1.2rem;padding:3px 10px}}@media(max-width:480px){.rsoft-content{padding:14px}.rsoft-title{font-size:1.2rem}.rsoft-info-grid{grid-template-columns:1fr;gap:8px}.rsoft-info-box{display:flex;align-items:center;justify-content:flex-start;gap:12px;text-align:left;padding:12px 16px}.rsoft-info-ico{margin-bottom:0;font-size:1.3rem;min-width:24px}.rsoft-info-detail{display:flex;flex-direction:column}.rsoft-countdown-box{flex-direction:column;gap:8px;text-align:center}.rsoft-btn-blue,.rsoft-btn-green{padding:12px 16px;font-size:.95rem}}';
